...
Given(/^a bunch of existing invoices$/) do
  ...
  create(:billing_machine_invoice, customer: c1, date: Time.zone.now.to_date, paid: true)
  create(:billing_machine_invoice, customer: c2, date: Time.zone.now.to_date)
  create(:billing_machine_invoice, customer: c3, date: Time.zone.now.to_date)
  create(:billing_machine_invoice, customer: c1, date: Time.zone.now.to_date - 2.days)

  create(:billing_machine_invoice, customer: i1, date: Time.zone.now.to_date - 3.days)
  create(:billing_machine_invoice, customer: i2, date: Time.zone.now.to_date - 3.days)
  create(:billing_machine_invoice, customer: i3, date: Time.zone.now.to_date - 3.days)
end
